<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
      <a class="navbar-brand me-5 fw-bold f-3 h-font" href="index.php">Hotel-Kita</a>
      ...
      <div class="modal-content">
        <form action="">
          <div class="modal-header">
            ...
            <button type="reset" class="btn-close shadown-none" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <form action="">
          ...
          <div class="modal-body">
            <span class="badge rounded-pill bg-light text-dark mb-3 text-dark mb-3 text-wrap lh-base">
              Note: Your details must match with your ID (Aadhaar card, passpost, driving license, etc.)
